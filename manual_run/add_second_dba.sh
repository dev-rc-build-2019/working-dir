...
#     ntid      = application dba ntid's
#     mailuser  = application dba email address
#     passwd    = random password for application dba account
#*****************************
# DATE           Name            Description
# -------------  --------------- -----------------------------
# 03.12.2020     R. Cutler       Createdd
#
#################################
...
lport="1531"
dbver="19.0.0"
passwd=`< /dev/urandom tr -dc A-Z-a-z-0-9 | head -c12`
...
echo -e "Oracle 19c VML" ${mailuser} < ${filename}
###############################
touch ${notifyfile}
echo -e "Subject:  ORACLE 19c VML\n" > ${notifyfile}
